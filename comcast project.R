...
#INSIGHTS:- From the above trend chart, we can clearly see that complaints for the month of June is 1046 which is maximum.
...
#From the above pie chart we can clearly see that there are total 76.75% Complaints resolved.
